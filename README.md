...
## 📌 Overview
Augmented Reality (AR) and Virtual Reality (VR) systems typically operate in a local world coordinate (WC) frame with arbitrary origin and orientation. However, many navigation and location-based services require alignment with a global geodetic frame (LLA: latitude, longitude, altitude) and, critically, True North (TN).
